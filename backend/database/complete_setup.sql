-- ==============================================
-- Global Education Database - Complete Setup
-- ==============================================
-- This file creates the database, user, and all tables with updated fields
-- Run this script as MySQL root user or a user with CREATE DATABASE privileges
-- ==============================================

-- Create database
CREATE DATABASE IF NOT EXISTS global_education CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- Students table (with all updated fields)
...
-- Consultants table (with all updated fields)
...
-- Student inquiries table (with all updated fields)
...
('site_phone', '+91 84600 00006', 'Default site phone number'),
...
-- SETUP COMPLETE
-- ==============================================
-- Database and user have been created successfully
-- All tables have been created with updated fields
